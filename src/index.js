...
var base = Rebase.createClass({
  apiKey: "AIzaSyA2VjV_NvGECumhvjk7w4Awb6YKVMWNCUQ",   // replace with your Firebase application's API key
  databaseURL: "https://final-9c215.firebaseapp.com", // replace with your Firebase application's database URL
})
  ...
  render: function() {
    return (
      <div>
        ...
        <SortBar currentView={this.state.currentView} viewChanged={this.viewChanged} movieCount={this.state.movies.length} />
